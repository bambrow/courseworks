...
public class ArcadeKeys {
	...
	/**
	 * Determine if a certain key is pressed (for a certain player).
	 * @param player	player ID
	 * @param key		the desired key
	 * @return		true if the certain key is pressed (transformed key)
	 */
	...
	/**
	 * Find the certain key from the KEYS array.
	 * @param player	player ID
	 * @param key		the desired key
	 * @return		the transformed key in the KEYS array corresponding to the input parameters (player and key)
	 */
